...
def getthresholdedimg(im):
    ...
    '''this function take RGB image.Then convert it into HSV for easy
    colour detection and threshold it with yellow and blue part as
    ...
    cv.InRangeS(imghsv, cv.Scalar(20, 100, 100), cv.Scalar(30, 255, 255), imgyellow)
    # Select a range of blue color
    cv.InRangeS(imghsv, cv.Scalar(100, 100, 100), cv.Scalar(120, 255, 255), imgblue)
